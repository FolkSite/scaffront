...
var stylesDistConfig = {
  src: 'dist/css',
  extnames: ['css', '!min.css'],
  deep: false,
  dest: 'dist/css',
  ...
  cleanups: __.getGlobPaths('dist/css', ['min.css', 'min.css.map'], true)
};
...
var tasks = {
  build: {
    sass: {
      ...
      cleanups: __.getGlobPaths('dist/css', ['css', 'css.map', '!min.css', '!min.css.map'], true)
    },
    css: {
      src: 'app/styles',
      extnames: ['css', '!_*.css'],
  ...
  dist: {
    sass: stylesDistConfig,
    css: stylesDistConfig,
  }
};
