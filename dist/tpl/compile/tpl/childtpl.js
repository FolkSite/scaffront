...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (config, user) {
...
}}.call(this,"config" in locals_for_with?locals_for_with.config:typeof config!=="undefined"?config:undefined,"user" in locals_for_with?locals_for_with.user:typeof user!=="undefined"?user:undefined));;return buf.join("");
}